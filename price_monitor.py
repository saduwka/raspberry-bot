...
async def get_kaspi_category_items(url):
    try:
        await _wait()
...
async def get_olx_category_items(url):
    items = []
    try:
        rss_url = url
